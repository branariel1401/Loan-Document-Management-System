	...
	if(isset($_GET['error']) && $_GET['error']=='FileMimeInvalid') {
		...
		echo '<form method="post" enctype="multipart/form-data" action="">';
			...
			echo '<div class="form-group">';
				echo '<label for="docType" class="control-label">Loan Number</label>';
				...
				echo '</select>';
				echo '<label for="docType" class="control-label">Doc Type</label>';
...
if(isset($_POST['submit']) && $_POST['submit']=="submit") {
	...
	if($fileMime!='application/pdf')
		...
		$dblink->query($sql) or
			redirect("upload_new.php?error=dbfailed");
			logging_err($now,'Database',$dblink->errno,$dblink->error);
